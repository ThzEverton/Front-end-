...
import {
  Loader2, Plus, Users, CalendarDays,
...
function DetalhesTurmaModal({ turmaId, onClose, isGerente, onAtualizar }) {
  ...
  useEffect(() => { fetchDetalhes() }, [turmaId])
...
export default function TurmasPage() {
 ...
 async function handleAprovar(id) {
  try {
    console.log('Aprovando turma ID:', id)
...
function TurmaCard({ turma, isGerente, onVerDetalhes, onEntrar, onSair, onAprovar, onRecusar }) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      ...
      {/* Código de convite visível para gerente no card */}
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* Botões da gerente para turmas pendentes */}
        ...
        {isGerente && isPendente && showMotivo && (
          <div className="w-full flex gap-2 mt-1">
            ...
            />
            <button
              onClick={() => { onRecusar(motivo); setShowMotivo(false) }}
